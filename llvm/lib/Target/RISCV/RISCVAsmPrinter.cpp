...
static MCOperand lowerSymbolOperand(const MachineOperand &MO, MCSymbol *Sym,
  ...
  case RISCVII::MO_CCALL:
    ...
    break;
  case RISCVII::MO_CHERI_COMPARTMENT_CGPREL_HI:
    Kind =  RISCVMCExpr::VK_RISCV_CHERI_COMPARTMENT_CGPREL_HI;
    break;
  case RISCVII::MO_CHERI_COMPARTMENT_CGPREL_LO_I:
    Kind =  RISCVMCExpr::VK_RISCV_CHERI_COMPARTMENT_CGPREL_LO_I;
    break;
  case RISCVII::MO_CHERI_COMPARTMENT_CGPREL_LO_S:
    Kind =  RISCVMCExpr::VK_RISCV_CHERI_COMPARTMENT_CGPREL_LO_S;
    break;
  case RISCVII::MO_CHERI_COMPARTMENT_PCCREL_HI:
    Kind = RISCVMCExpr::VK_RISCV_CHERI_COMPARTMENT_PCCREL_HI;
    break;
  case RISCVII::MO_CHERI_COMPARTMENT_PCCREL_LO:
    Kind =  RISCVMCExpr::VK_RISCV_CHERI_COMPARTMENT_PCCREL_LO;
    break;
 case RISCVII::MO_CHERI_COMPARTMENT_SIZE:
    Kind = RISCVMCExpr::VK_RISCV_CHERI_COMPARTMENT_SIZE;
    break;
  }
