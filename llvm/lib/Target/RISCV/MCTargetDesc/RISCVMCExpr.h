...
public:
  enum VariantKind {
    ...
    VK_RISCV_CCALL,
    VK_RISCV_CHERI_COMPARTMENT_CGPREL_HI,
    VK_RISCV_CHERI_COMPARTMENT_CGPREL_LO_I,
    VK_RISCV_CHERI_COMPARTMENT_CGPREL_LO_S,
    VK_RISCV_CHERI_COMPARTMENT_PCCREL_HI,
    VK_RISCV_CHERI_COMPARTMENT_PCCREL_LO,
    VK_RISCV_CHERI_COMPARTMENT_SIZE,
