...
attributes #0 = { nounwind "frame-pointer"="all" "interrupt-state"="disabled" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+a,+c,+m,+relax,-save-restore,+no-rvc-hints" }
attributes #1 = { "frame-pointer"="all" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+a,+c,+m,+relax,-save-restore,+no-rvc-hints" }
attributes #2 = { nounwind "frame-pointer"="all" "interrupt-state"="enabled" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+a,+c,+m,+relax,-save-restore,+no-rvc-hints" }
attributes #3 = { nounwind "frame-pointer"="all" "interrupt-state"="inherit" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+a,+c,+m,+relax,-save-restore,+no-rvc-hints" }
