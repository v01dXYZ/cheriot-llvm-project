...
attributes #0 = { minsize nounwind optsize "cheri-compartment"="example" "frame-pointer"="none" "interrupt-state"="enabled" "min-legal-vector-width"="0" "minimum-stack-size"="256" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="cheriot" "target-features"="+xcheri,+no-rvc-hints,-64bit,-relax,-save-restore" }
attributes #1 = { minsize optsize "cheri-compartment"="example" "frame-pointer"="none" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="cheriot" "target-features"="+xcheri,-64bit,-relax,-save-restore" }
attributes #2 = { minsize nounwind optsize }
attributes #3 = { minsize nounwind optsize "cheri-compartment"="example" "frame-pointer"="none" "interrupt-state"="enabled" "min-legal-vector-width"="0" "minimum-stack-size"="512" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="cheriot" "target-features"="+xcheri,-+no-rvc-hints,-64bit,-relax,-save-restore" }
attributes #4 = { minsize nounwind optsize "cheri-compartment"="example" "frame-pointer"="none" "interrupt-state"="enabled" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="cheriot" "target-features"="+xcheri,+no-rvc-hints,-64bit,-relax,-save-restore" }
